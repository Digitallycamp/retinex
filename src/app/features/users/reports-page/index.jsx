					...
					<div className='relative z-10 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-3 sm:gap-4'>
						<div>
							...
							<p className='text-white/80 text-xs sm:text-sm lg:text-base'>
								Track performance, analyze trends, and make data-driven
								decisions
							</p>
						</div>
				...
				{overallMetrics && (
					<div className='grid grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4'>
						...
						<div className='bg-white rounded-xl p-3 sm:p-4 border-l-4 border-l-purple-500 shadow-sm'>
							...
							<p className='text-lg sm:text-xl font-black text-green-900'>
				...
				<div className='bg-white rounded-xl border shadow-sm overflow-hidden'>
					<div className='p-4 sm:p-5 border-b bg-gradient-to-r from-[#3F0E40]/5 via-white to-white'>
						<div className='flex items-center gap-3'>
							...
							<div>
								<h2 className='font-bold text-[#3F0E40] text-base sm:text-lg'>
									Sales Orders Report
								</h2>
				...
				{financialReport.data.length > 0 && (
					<div className='bg-white rounded-xl border shadow-sm overflow-hidden'>
						<div className='p-4 border-b bg-gradient-to-r from-[#3F0E40]/5 via-white to-white'>
							<h3 className='font-bold text-[#3F0E40]'>
							...
							<table className='w-full text-sm'>
								...
								<tbody>
									{financialReport.data.map((product) => (
										...
										>
											<td className='p-3 font-medium text-[#3F0E40]'>
												{product.name}
											</td>
											...
											<td className='p-3 text-right text-green-900 font-medium'>
